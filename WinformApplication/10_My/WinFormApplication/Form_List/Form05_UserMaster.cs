...
namespace Form_List
{
    ...
    public partial class Form05_UserMaster : BaseChildForm
    {
        ...
        private void Form05_UserMaster_Load(object sender, EventArgs e)
        {
            ...
            _GridUtil.InitColumnGrid(dgvGrid, "USERCODE", "사용자ID", typeof(string),    100, DataGridViewContentAlignment.MiddleLeft, false);
            _GridUtil.InitColumnGrid(dgvGrid, "USERNAME", "사용자명", typeof(string),    100, DataGridViewContentAlignment.MiddleLeft, true);
            _GridUtil.InitColumnGrid(dgvGrid, "PASSWORD", "비밀번호", typeof(string),    100, DataGridViewContentAlignment.MiddleLeft, true);
            _GridUtil.InitColumnGrid(dgvGrid, "PW_F_CNT", "실패횟수", typeof(int),       100, DataGridViewContentAlignment.MiddleRight, true);
            _GridUtil.InitColumnGrid(dgvGrid, "DEPTCODE", "부서",     typeof(string),    100, DataGridViewContentAlignment.MiddleLeft, true);
            _GridUtil.InitColumnGrid(dgvGrid, "MAKEDATE", "등록일시", typeof(DateTime),  200, DataGridViewContentAlignment.MiddleLeft, false);
            _GridUtil.InitColumnGrid(dgvGrid, "MAKER",    "등록자",   typeof(string),    100, DataGridViewContentAlignment.MiddleLeft, false);
            _GridUtil.InitColumnGrid(dgvGrid, "EDITDATE", "수정일자", typeof(DataTable), 200, DataGridViewContentAlignment.MiddleLeft, false);
